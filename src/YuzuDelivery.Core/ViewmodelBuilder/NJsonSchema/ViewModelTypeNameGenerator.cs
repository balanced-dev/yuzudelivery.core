...
namespace YuzuDelivery.Core.ViewmodelBuilder.NJsonSchema;

internal class ViewModelTypeNameGenerator : ITypeNameGenerator
{
    ...
    private string GetCurrentSchemaId(JsonSchema schema)
    {
