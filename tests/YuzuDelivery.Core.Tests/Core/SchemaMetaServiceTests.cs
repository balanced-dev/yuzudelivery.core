    ...
    public class SchemaMetaServiceTests
    {
        ...
        public void GetPossiblePathFileName_return_possible_paths_with_par_prefix_and_without_prefix()
        {
            ...
            if(RuntimeInformation.IsOSPlatform(OSPlatform.Windows))
            {
                ...
                Assert.AreEqual(@"c:\test\parTest.meta", output.First());
                Assert.AreEqual(@"c:\test\test.meta", output.Last());
            }
            else
            {
                config.TemplateLocations.Returns(new List<ITemplateLocation>
                ...
                Assert.AreEqual("/foo/test/parTest.meta", output.First());
                Assert.AreEqual("/foo/test/test.meta", output.Last());
            }
        }
